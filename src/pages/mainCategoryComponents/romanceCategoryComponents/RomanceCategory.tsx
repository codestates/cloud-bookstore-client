...
const RomanceCategory: React.FC = () => {
  const [romanceNovelData, setRomanceNovelData] = useState<RomanceCategoryData>(
    {
      data: [
        {
          id: 1,
  ...
  return (
    <div className="wholeFantasyCategoryWrapper">
      <div className="fantasyCategoryInnerWrapper">
        <SelectBoxNav categorizedData={romanceNovelData} />
      </div>
    </div>
  );
};
